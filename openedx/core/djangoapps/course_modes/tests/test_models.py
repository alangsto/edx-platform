...
from openedx.core.djangoapps.course_modes.helpers import enrollment_mode_display
from openedx.core.djangoapps.course_modes.models import CourseMode, Mode, get_cosmetic_display_price, invalidate_course_mode_cache
...
class TestDisplayPrices(ModuleStoreTestCase):
    ...
    def test_get_cosmetic_display_price(self):
        ...
        with patch('openedx.core.djangoapps.course_modes.models.CourseMode.min_course_price_for_currency', return_value=registration_price):
